...
Tutorial to build and run your own "photo booth" on a [Raspberry Pi](https://www.raspberrypi.org):
 ...
 * Autostart fotobox: open file with `sudo nano ~/.config/lxsession/LXDE-pi/autostart` add this line `@sudo /home/pi/Downloads/fotobox` at the end of the file.
